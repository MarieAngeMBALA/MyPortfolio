...
window.doresize = function() {
  // Ajoutez ici le comportement attendu de doresize, par exemple :
  console.log("Resizing as per prettyPhoto requirements.");
};
window.scroll_pos = function() {
  // Ajoutez ici le comportement attendu de doresize, par exemple :
  console.log("Resizing as per prettyPhoto requirements.");
};
window.hashtag = function() {
  // Ajoutez ici le comportement attendu de doresize, par exemple :
  console.log("Resizing as per prettyPhoto requirements.");
};
